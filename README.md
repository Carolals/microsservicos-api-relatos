...
https://excalidraw.com/#json=umbor9S0JeIjT-2CAPSMa,lZ0i7iot6lzYM82XPPWJIw
...
POST /auth/login
POST /auth/refresh
POST /auth/logout   (precisa Bearer Token)
...
O Gateway abstrai as URLs internas e centraliza políticas transversais:
